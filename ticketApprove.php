...
$messageintro ="
<font style='font-family:Monospace;color:green;font-style:normal;font-size:16px'> 
	Ticket <b>".$ticketnumber."</b> has been approved ! 
</font>
	<br>";
...
$message = Swift_Message::newInstance('New Ticket '.$ticketnumber.'')
  ...
  ->setCc(array($email,'salesreport.slvismin@mineski.net','operations@mineski.net','customerfeedback@mineski.net','chevmikhail.salvador@mineski.net'))    
  ->setTo(array('pondobilling@gmail.com'))
...
$query = "UPDATE ticket SET approveDate = '".$datetime."', Status ='A' WHERE ticketId='".$ticketnumber."';"; 	
